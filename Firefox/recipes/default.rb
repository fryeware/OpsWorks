...
Chef::Log.info("******executing NinitePro installer ******")
execute 'firefox' do
  command 'C:/Windows/Temp/NiniteProTrial.exe /select Chrome Firefox Flash QuickTime Reader Shockwave Silverlight /silent c:/Windows/Temp/appreport.txt'
end
