...
Register-ScheduledTask -Xml (get-content c:/Windows/Temp/PSLogOutRunt.xml | out-string) -TaskName \"Log Out RDS User Connections for Safeweb\" -User safeweb\\safetydance -Password Pass4saf –Force;
    EOH
