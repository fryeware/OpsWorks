...
powershell_script "PSLogOutSWL" do
  code <<-EOH
...
Register-ScheduledTask -Xml (get-content c:/Windows/Temp/PSLogOutSWL.xml | out-string) -TaskName \"Log Out RDS User Connections for Safeweb Linux\" -User safeweb\\safetydance -Password Pass4saf –Force;
    EOH
